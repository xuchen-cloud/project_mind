...
export const PROJECT_SIDEBAR_WIDTH_DEFAULT_PX = PROJECT_SIDEBAR_WIDTH_MIN_PX;
export const PROJECT_SIDEBAR_WIDTH_MAX_PX = 480;
export const PROJECT_SIDEBAR_COLLAPSED_WIDTH_PX = 34;
export const TODO_RAIL_WIDTH_MIN_PX = 280;
export const TODO_RAIL_WIDTH_DEFAULT_PX = TODO_RAIL_WIDTH_MIN_PX;
export const TODO_RAIL_WIDTH_MAX_PX = 560;
export const TODO_RAIL_COLLAPSED_WIDTH_PX = 34;
